...
public class Links extends TableImpl<LinksRecord> {
     ...
     */
    public final TableField<LinksRecord, Short> LINK_TYPE = createField(DSL.name("LINK_TYPE"), SQLDataType.SMALLINT.nullable(false), this, "");
    ...
    /**
     * The column <code>LINKS.STATUS</code>.
     */
    public final TableField<LinksRecord, Short> STATUS = createField(DSL.name("STATUS"), SQLDataType.SMALLINT.nullable(false), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function5<? super Long, ? super Short, ? super String, ? super OffsetDateTime, ? super Short, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function5<? super Long, ? super Short, ? super String, ? super OffsetDateTime, ? super Short, ? extends U> from) {
