...
class JpaLinkServiceTest extends IntegrationTest {
    ...
    class UpdateStatusTest {
        ...
        void updateStatusTest() {
            ...
            assertThat(linkRepository.findById(1L).get().getStatus()).isEqualTo(LinkStatus.BROKEN);
        }
    }
    ...
    class UpdateCheckedAtTest {
        ...
        void updateCheckedAtTest() {
            ...
            assertThat(linkRepository.findById(1L).get().getCheckedAt()).isEqualTo(CHECKED_AT.plusHours(1));
        }
    }
